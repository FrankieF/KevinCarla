package 
{
	...
	public class Ghost2 extends GameObject
	{
		...
		public function Ghost2()
		{
			...
			stateReference = [
					{name:"idle", animation:Gh2Idle},
					{name:"aggro", animation:Gh2Aggro},
			];
		}
		...
		private function movement():void
		{
			...
			//{
				...
				if (changeDirection >= 0)
				{
					...
					for (var i:int = 0; i < $list.length; i++)
					{
						...
						//trace("currentPlayer : " + currentPlayer );
			...
			moveBy([Wall, Door, Enemy], velocity.x, velocity.y, collides_mc);
